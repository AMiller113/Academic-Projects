...
//        String[] arrName;
        ...
        final User the_user = User._get_user_interface();
        final DBItems database_ref = DBItems.get_instance();
        ...
        // final version will need to implement via DB as below
        /* arrType = /* List of items from the DB that start with whatever is being entered */

        // for test only
//        arrType = new String[]{"Test1", "Second Test", "A test"};
        ...
        // final version will need to implement via DB as below
        /* arrName = /* List of items from the DB that start with whatever is being entered */

        // for test only
//        arrName = new String[]{"Test1", "Second Test", "A test"};
...
//        Button addItemDB = (Button) findViewById(R.id.OpenAddDBButton);
//        addItemDB.setOnClickListener(new View.OnClickListener(){
//
//            @Override
//            public void onClick(View view) {
//                Intent myIntent = new Intent(AddItem.this, AddItemToDB.class);
//                myIntent.putExtra("Name of List", list_name);
